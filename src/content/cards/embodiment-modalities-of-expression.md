...
summary:
  ...
  caption: Most expression here flows through creaturely robots and desktop agents — with a bulb and ambient objects at the quiet end.
display:
  mode: scatter-2d
  x:
    metric: expressiveness
    label: Utilitarian → expressive
    direction: asc
  y:
    metric: social_legibility
